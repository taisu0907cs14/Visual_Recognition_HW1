...
# --- 設定超參數 ---
EXP_NAME = "resnext_cbam_freeze_thaw_label_smoothing_weighted_strong_aug"  # 這個名字會用來命名輸出資料夾，建議包含模型架構與訓練策略的關鍵字，方便日後回顧
DATA_DIR = "./data"
BATCH_SIZE = 128
...
def main():
    ...
    scheduler2 = optim.lr_scheduler.SequentialLR(
        optimizer2, schedulers=[s1, s2], milestones=[5]
    )
